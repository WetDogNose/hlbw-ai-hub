...
**AGENT DIRECTIVES & STRUCTURAL INTEGRITY:** Whenever establishing new rules, instructions, or hints for other AI agents to follow across the `hlbw-ai-hub` workspace, you MUST format them entirely utilizing rigorous Markdown Callouts (e.g., `> [!IMPORTANT]`, `> [!NOTE]`, `> [!TIP]`).
