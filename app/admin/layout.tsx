...
export default async function AdminLayout({
  ...
  return (
    <div className="container" style={{ padding: "var(--spacing-8)" }}>
      <header
        className="header flex flex-wrap justify-between items-center gap-4"
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1
              className="header-title flex items-center gap-2"
              style={{ margin: 0 }}
            >
            ...
            <p
              ...
              style={{ marginTop: "var(--spacing-1)", marginBottom: 0 }}
            >
      ...
      <div
        className="nav-links flex flex-wrap gap-4"
        style={{
